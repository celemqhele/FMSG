...
export function GuestCVModal({ isOpen, onComplete, onSkip }: GuestCVModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center">
      ...
      <div className="relative bg-white border border-gray-200 rounded-2xl p-6 max-w-md mx-4 space-y-6 shadow-xl">
        <button
          onClick={onSkip}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">AI extracts job titles, location, and industry for better matches</p>
          </div>
        </div>
        ...
        {!parsed ? (
          <>
            {!uploading ? (
              <div
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-[var(--color-accent)] transition-colors"
              ...
              >
                ...
                {file ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-600">Drag your CV here or click to browse</p>
              ...
              <div className="flex flex-col items-center gap-3 py-4">
                ...
                <p className="text-sm text-gray-600">AI is analysing your CV...</p>
              </div>
            )}
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {parsed.job_titles.map((t) => (
                    <span key={t} className="px-2 py-0.5 text-xs rounded-full bg-[var(--color-accent)]/10 text-[var(--color-accent)] border border-[var(--color-accent)]/20">
                      {t}
                    </span>
                  ))}
                </div>
              ...
              {parsed.industry && (
                <div>
                  ...
                  <p className="text-sm text-gray-700">{parsed.industry}</p>
                </div>
              )}
            </div>
